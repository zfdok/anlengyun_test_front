...
module.exports = {
  ...
  systemName: '安冷云',         //系统名称
  copyright: '2020-2025 山东安冷新材料科技有限公司 鲁ICP备19016556号-2 ｜ 增值电信业务经营许可证：鲁B2-20130466',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    { link: 'http://www.anleng-tec.com/', name: ' 安冷科技官方网站', icon: 'github' },
    { link: 'http://www.uroica.com.cn/', name: ' 精准信息官方网站', icon: 'github' },
  ],
}
