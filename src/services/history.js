...
import { HISTORY_GET_DEVICE_HISTORY_LIST, REPORT_GEN_REPORT, REPORT_GET_REPORT, REPORT_SET_RECINFO, HISTORY_GET_DEVICE_HISTORY } from '@/services/api'
...
export async function get_device_history(pram) {
